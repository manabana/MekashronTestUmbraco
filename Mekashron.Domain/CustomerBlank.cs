            ...
            return
                $@"
                    <ns1:Entity_Add env:encodingStyle=""http://www.w3.org/2003/05/soap-encoding"">
                                <ol_EntityId xsi:type=""xsd:int"">{this.EntityId}</ol_EntityId>
                                <ol_UserName xsi:type=""xsd:string"">{this.Username}</ol_UserName>
                                <ol_Password xsi:type=""xsd:string"">{this.Password}</ol_Password>
